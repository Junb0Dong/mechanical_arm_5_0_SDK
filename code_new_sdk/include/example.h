...
extern "C"{
/*倒水demo*/
void pour_water(int deviceInd,int canInd);

/*直线运动demo*/
void linear_motion(int deviceInd,int canInd); 

/*demo_1
    机械臂码垛动作：用角度
*/
void demo_1(int deviceInd,int canInd);

/*demo_2
    机械臂码垛 1kg ：用角度
*/
void demo_2(int deviceInd,int canInd);

/*demo_3
    3kg机械臂码垛：用坐标点，随着物体高度的增加最后位置改变
*/
void demo_3(int deviceInd,int canInd);

/*倒水修改版*/
void demo_4(int deviceInd,int canInd);

/*倒水修改版2.0*/
void demo_5(int deviceInd,int canInd);

/*倒水修改版3.0*/
void demo_6(int deviceInd,int canInd);

/*直线运动画矩形*/
void Drawing_rectangles_in_linear_motion(int deviceInd,int canInd);

void linearMove(float startPos[6], float endPos[6], int numSteps, int deviceInd, int canInd);
// void linearMove(float startPos[6], float endPos[6], int numSteps);
/*拖动示教  
    参数：
